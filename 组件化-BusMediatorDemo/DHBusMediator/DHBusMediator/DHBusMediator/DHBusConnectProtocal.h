...
/**
 *  DHBusConnectProtocal 挂接点协议
 *
 *  每个业务模块在对外开放的挂接点实现这个协议，以便被DHBusMediator发现和调度
 */

@protocol DHBusConnectProtocal <NSObject>
...
-(BOOL)canOpenSchemeURL:(nonnull NSURL *)URL;
